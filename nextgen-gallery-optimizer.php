...
Description: Ng gallery optimizer modified is a modified version is a modified from of nexrgen gallery optimizer and has added support for all the 10 shortcodes for ng gallery .It also includes and automatically integrates the fantastic Fancybox lightbox script, so now you can have gorgeous galleries AND a speedy site!
Author: Kiran Antony
Version: 1.0

Author URI: http://www.kiranantony.com

Copyright 2012 Kiran Antony | mail@kiranantony.com
...
function nggom_thanks_for_downloading() {
	...
	if (isset($_GET['page']) && $_GET['page'] =='nggom_options') {
    	...
    	if (isset($nggom_options['show_message']) && ($nggom_options['show_message'] == 'yes')) {
			...
			<p>Thanks for downloading Ng Gallery Optimizer modified! Please disable ngg Optimizer modified if installed. Else it may cause problems </p>
			</div>
			';
